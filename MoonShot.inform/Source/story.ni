...
Rule for writing a paragraph about the head rocket scientist:
	if the head rocket scientist is enraged:
		say "[The noun] huffs about the room, scribbling on chalk boards, sparing you only the occasional angry glance.";
	otherwise:
...
In the propulsion lab is a person called other scientists.  The other scientists are plural-named.
